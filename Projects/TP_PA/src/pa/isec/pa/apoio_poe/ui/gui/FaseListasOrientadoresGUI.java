...
public class FaseListasOrientadoresGUI extends AnchorPane {
    ManagerUI managerUI;
    Button back;


    public FaseListasOrientadoresGUI(ManagerUI managerUI) {
    ...
    private void createViews() {
        Label mp = new Label("Listas de orientadores");
    ...
    private void update() {
        if (managerUI.getState() != State.FASELISTASORIENTADORES) {
